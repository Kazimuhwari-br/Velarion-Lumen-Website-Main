/* Velarion Profile Cargo — componente autônomo. */
(function(window){
  "use strict";
  if (window.VelarionProfileCargo) return;
  const TYPE="role";
  function core(){ const api=window.VelarionProfileCore; if(!api) throw new Error("VelarionProfileCargo requer velarion-profile-core.js."); return api; }
  ...
  window.VelarionProfileCargo={render};
})(window);
