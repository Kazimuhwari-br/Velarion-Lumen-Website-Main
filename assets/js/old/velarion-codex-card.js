/* ======================================================================
   ...
   - Usa namespace próprio window.VelarionCodexCard e classe .vlc-roster-entry.
   - Não sobrescreve window.VelarionLumenCard e não interfere no card vertical.
   ====================================================================== */
(function(window, document) {
  ...
  function createProfileRoster(profile) {
    ...
    return `
      <article
        class="vlc-roster-entry ${statusClass}"
  ...
  window.VelarionCodexCard = {
    version: "codex-roster-v3-separated",
    setData,
    renderPlayerCard,
    hydrate
  };
